...
CREATE TABLE `reviews` (
  ...
  `review_series_id` int(11) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `reviews` (`review_id`, `review_movie_id`, `review_user_id`, `review_rating`, `review_content`, `review_series_id`) VALUES
(9, 2, 40, 2, 'gh', 0),
(10, 1, 40, 1, 'no', 0),
(11, 1, 40, 3, 'nice movie', 0);
...
--
ALTER TABLE `reviews`
  MODIFY `review_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
